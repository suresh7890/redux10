...
function mapStateToProps(state) {
    return {
        ...
        incCounter : state.incrementCounter.incrementState,  // INCREMENTCOUNTER IS THE FUNCTION AND ITS STATE IS RETRIEVED
        decCounter : state.decrementCounter.decrementState
        //AL THE REDUCERS STATE WILL COME.. 
...
class App extends Component {
  ...
  render() {
    return (
      <div >
        App {this.props.incCounter + this.props.decCounter}  // USING BOTH VARIABLE THAT IS FROM THE REDUCERS
        <div>
          <br/>
          Event in App.jsx <br/>
